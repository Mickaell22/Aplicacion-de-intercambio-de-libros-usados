    ...
    <header class="header">
        <div class="box_presentacion">
            <div class="box_presentacion_opaco">
                <h1 class="titulo">Formulario de ingreso de categoria</h1>
            </div>
        </div>
    </header>
    <form action="index.php?c=categoria&f=save" method="POST" class="form" id="form">
        <fieldset>
            <legend>
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Ingrese el titulo de la categoria" id="nombre" name="nombre">
                </div>
                <div class="form-group">
                    <label for="descripcion">Descripcion de la categoria</label>
                    <textarea name="descripcion" id="descripcion"
                        placeholder="Ingrese la descripcion de la categoria"></textarea>
                </div>
                <div class="form-group">
