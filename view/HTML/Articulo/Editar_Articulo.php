    ...
    <div class="form-container">
        <form class="form-upload" id="formulario" method="POST" action="index.php?c=articulo&f=edit"
            ...
            <div class="form-input">
                <input type="hidden" id="id" name="id" value=" <?php echo $article["art_id"]; ?> ">
            </div>

            <!-- Título del libro -->
            <div class="form-input">
                <label for="titulo">Título del articulo</label>
                <input type="text" id="titulo" name="titulo" value=" <?php echo $article["art_titulo"]; ?> ">
            </div>

            <!-- Introduccion -->
            <div class="form-input">
                <label for="introduccion">Introduccion</label>
                <textarea id="introduccion" name="introduccion" rows="4">
                        <?php echo $article["art_introduccion"]; ?> 
                    </textarea>
            </div>
            ...
            <div class="form-input">
                ...
                <textarea id="descripcion" name="descripcion" rows="4">
                        <?php echo $article["art_descripcion"]; ?>
                    </textarea>
            </div>
            ...
            <div class="form-input">
                ...
                <textarea id="conclusion" name="conclusion" rows="4">
                        <?php echo $article["art_conclusion"]; ?>
                    </textarea>
            </div>
            ...
            <div class="form-input">
                ...
                <select id="categoria" name="categoria" class="form-control">
                    ...
                    foreach ($categorias as $cat) {
                        ...
                        ?>
                        <option <?php echo $selected ?> value=" <?php echo $cat['cat_id'] ?> ">
            ...
            <input type="hidden" name="imagen_actual" value="<?php echo $article['art_imagen']; ?>">

            <!-- Imagen actual -->
            <?php if (!empty($article["art_imagen"])): ?>
                <div class="form-input">
                    <label>Portada Actual</label>
                    <img src="<?php echo $article["art_imagen"]; ?>" alt="Portada actual"
            ...
            <div class="form-input">
                <label for="portada">Nueva portada de su articulo (opcional)</label>
            ...
            <div class="form-input">
                ...
                <input type="text" id="autores" name="autores" value=" <?php echo $article["art_autores"]; ?> ">
            </div>

            <!-- Referencias -->
            <div class="form-input">
                <label for="referencias">Referencias:</label>
                <input type="text" id="referencias" name="referencias" value=" <?php echo $article["art_ref"]; ?> ">
            </div>

            <!-- Botón de envío -->
            <div class="form-input">
                <button class="Info button" type="submit">Actualizar</button>
