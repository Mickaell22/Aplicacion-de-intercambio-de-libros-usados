    ...
    <main class="main">
        <div class="search">
            <form action="index.php" method="GET" class="search-form">
                ...
                <input type="text" name="q" class="search-input" placeholder="Busca tus libros..."
        ...
        <?php else: ?>
            <?php foreach ($libros as $libro): ?>
                <div class="elemento">
                    ...
                    <h3><?php echo html_entity_decode($libro['titulo']); ?></h3>
                    <p class="autor">por <?php echo htmlspecialchars($libro['autor']); ?></p>
                    <input type="button" class="Info button" value="Información"
                        onclick="location.href='index.php?c=libro&f=info&id=<?php echo $libro['id']; ?>'">
